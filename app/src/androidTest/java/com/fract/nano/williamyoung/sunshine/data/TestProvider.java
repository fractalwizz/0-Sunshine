...
import com.fract.nano.williamyoung.sunshine.data.WeatherContract.LocationEntry;
...
public class TestProvider extends AndroidTestCase {
    ...
    //Check to make sure the content provider is registered correctly.
    ...
    // verify ContentProvider returns correct type for each URI type it can handle
    ...
    //uses weather database directly to insert + use ContentProvider to read out data
    ...
    //uses location database directly to insert + use ContentProvider to read out data
